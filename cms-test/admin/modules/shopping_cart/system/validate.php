...
// if index isn't enabled for this page, use products as default instead
$return = array();
$return['mainUrl'] 		= $_config['admin_url'] . 'modules/shopping_cart/index.php';
$return['sideBarId']	= 'ecommerce';
