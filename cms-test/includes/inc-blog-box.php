...
?>			
			...
			<div class="titleline"><a  class="subpage" href="<?php echo $_config['path']['blog'] .$rec['url']; ?>"> <?php echo $rec['title']; ?> </a><div style="clear:both;height:1em;"></div><div class="byline clear">by <strong><?php echo $author; ?> | <?php echo $numcomments; ?></strong>&nbsp;&nbsp;<img src='admin/images/comments.png' alt='comments' /></div></div>
